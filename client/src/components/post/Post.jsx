// This code was written and edited by all members on the team
// Jefferson added code for block and unblock buttons
...
export default function Post({ post }) {
  ...
  // Jefferson added block and unblock handlers as well
  // as the html code for those buttons
